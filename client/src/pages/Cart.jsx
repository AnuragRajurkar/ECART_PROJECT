...
const Cart = () => {
    ...
    const {axios,products,cartItems,currency,getCartCount,removeFromCart,updateCartItem,navigate,getCartAmount,user,setCartItems} = useAppContext();
        ...
        try {
            ...
            if(paymentOption=="COD"){
                ...
                if(data.success)
                {
                    ...
                    //it will clear cartitems and redirect us to my-orders page
                    setCartItems({})
                    navigate('/my-orders')
                }else{
                    toast.error(data.message)
    ...
    useEffect(() => {
        if(user && products.length > 0 && cartItems)
        {
            getCart();
        }
    ...
    useEffect(() => {
  console.log("Cart Items:", cartItems ?? "No cart items yet");
                    ...
                    <div className="relative flex justify-between items-start mt-2">
                        ...
                        {showAddress && (
                            <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full">
                                ...
                                <p onClick={() => navigate("/add-address")} className="text-primary-500 text-center cursor-pointer p-2 hover:bg-primary-/10">
                                    Add address
                                </p>
                            </div>
                        )}
