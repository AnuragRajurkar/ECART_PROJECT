                ...
                <div className="flex items-end justify-between mt-3">
                    ...
                    <div onClick={(e) => {e.stopPropagation()}} className="text-primary">
                        {!cartItems[product._id] ? (
                            <button className="flex items-center justify-center gap-1 bg-primary/10 border-primary/40 cursor-pointer  md:w-[80px] w-[64px] h-[34px] rounded " onClick={() =>  addToCart(product._id)} >
